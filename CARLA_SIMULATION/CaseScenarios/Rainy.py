...
def main():
    ...
    # Create WeatherParameters object for rainy weather
    rainy_weather = carla.WeatherParameters(
        cloudiness=90.0,               # Overcast sky
        precipitation=80.0,           # High rain intensity
        precipitation_deposits=70.0,  # Rainwater on the ground
        sun_altitude_angle=30.0,      # Moderate sunlight
        fog_density=10.0,             # Slight fog
        fog_distance=30.0,            # Visibility in the rain
        wetness=100.0,                # Fully wet roads
        wind_intensity=15.0           # Windy conditions
    )
    
    # Apply the rainy weather
    set_weather(client, rainy_weather)
    print("Weather set to raining!")
